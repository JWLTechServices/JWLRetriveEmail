...
{
    class clsODCDS_Enterprise : clsCommon
    {
           ...
           string fileName, string extn, string datetime)
        {
            ...
            clsEnterpriseDB objEnterpriseDB = new clsEnterpriseDB();
            try
            {
                clsCommon.DSResponse objCMDsResponse = new clsCommon.DSResponse();
                objCMDsResponse = objEnterpriseDB.GetReadEmailMappingDetails_Enterprise(customerName, locationCode, productCode);
                if (objCMDsResponse.dsResp.ResponseVal)
                {
                    string tempfilePath = objCommon.GetConfigValue("AttachmentWorkingFolder");
                    string attachmentPath = objCommon.GetConfigValue("EnterPriseAutomationFileLocation");
                    ...
                    objDsRes = objEnterpriseDB.GetOrderPostTemplateDetails_Enterprise(customerName, locationCode, productCode, productSubCode);
                        ...
                        if (dsExcel.Tables.Count > 0)
                        {
                            ...
                            if (objDsRes.dsResp.ResponseVal)
                            {
                                ...
                                if (objreturnResponseGenOrdTemplate.ResponseVal)
                                {
                                    ...
                                    objBPRatesResponse = objEnterpriseDB.GetBillingRatesAndPayableRates_CustomerMappingDetails_Enterprise(company_no, customerNumber);
                                    if (objBPRatesResponse.dsResp.ResponseVal)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                executionLogMessage = "Diesel price data not found in this file " + fscRateDetailsfilepath + System.Environment.NewLine;
                                                ...
                                                string subject = "Diesel price data not found in this file " + fscRateDetailsfilepath;
                                            ...
                                            objfscRatesResponse = objEnterpriseDB.GetFSCRates_MappingDetails_Enterprise(Convert.ToInt32(company_no), Convert.ToInt32(customerNumber));
                                ...
                                {
                                    executionLogMessage = "Issue in Generating Order Template " + System.Environment.NewLine;
                                    ...
                                    emailSubject = "Issue in Generating Order Template";
            ...
            {
                executionLogMessage = "Exception in ProcessCDSODData" + System.Environment.NewLine;
            ...
            string productCode, string productSubCode, string datetime)
        {
            ...
            clsEnterpriseDB clsEnterpriseDB = new clsEnterpriseDB();
            ...
            clsCommon.DSResponse objDsRes = new clsCommon.DSResponse();
            objDsRes = clsEnterpriseDB.GetOrderPostTemplateDetails_Enterprise(customerName, locationCode, productCode, productSubCode);
         ...
         DataTable dtCDSBadData, DataTable dtCDSMissingConfigData, string company_no, string customerNumber, string fileName, string dateTime, string customerrefmappingcolumnname)
        {
            ...
            clsEnterpriseDB objclsEnterpriseDB = new clsEnterpriseDB();
            ...
            clsCommon.DSResponse objfscRatesResponse = new clsCommon.DSResponse();
            objfscRatesResponse = objclsEnterpriseDB.GetFSCRates_MappingDetails_Enterprise(Convert.ToInt32(company_no), Convert.ToInt32(customerNumber));
